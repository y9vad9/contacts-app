...
object Deps {
    ...
    const val androidComposeVersion = "1.4.0-alpha02"
    ...
    object Libs {
        ...
        object SQLDelight {
            const val AndroiDriver = "com.squareup.sqldelight:android-driver:1.5.4"
        }
        ...
        object Androidx {
            ...
            object Compose {
                ...
                const val Wear = "androidx.wear.compose:compose-foundation:1.1.0"
                const val WearMaterial = "androidx.wear.compose:compose-material:1.1.0"
            }
        }
